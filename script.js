const textElements = document.querySelectorAll('.text1, .text2, .text3, .text4,.text5,.text6, .quote1 ');
...
window.onload = function() {
    ...
    const textElements = document.querySelectorAll(".text1, .text2, .text3, .text4, .text5, .text6 ");
...
function startTypewriterEffect() {
    const elements = document.querySelectorAll('.quote1, .text7' );
    let delay = 0;
